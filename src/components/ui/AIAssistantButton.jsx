function AIAssistantButton({ onClick }) {
  return (
    <div className="fixed right-4 bottom-4 z-50 motion-safe:animate-[arcose-float_4s_ease-in-out_infinite] sm:right-6 sm:bottom-6">
      <button
        ...
        onClick={onClick}
      >
        <svg className="size-6" viewBox="0 0 48 48" fill="none" aria-hidden="true">
          <path d="M10 37 22.5 10h3L38 37" stroke="currentColor" strokeWidth="5" strokeLinecap="square" />
          <path d="M16.5 27.5h15" stroke="currentColor" strokeWidth="5" strokeLinecap="square" />
        </svg>
        <span>Ask me</span>
      </button>
    </div>
